...
#  DOCX
# ═════════════════════════════════════════════════════════════
def extract_docx_text(file_path: str) -> list[TextChunk]:
    if not DOCX_OK:
        return []
    chunks = []
    idx = 0
...
#  XLSX
# ═════════════════════════════════════════════════════════════
def extract_xlsx_text(file_path: str) -> list[TextChunk]:
    if not XLSX_OK:
        return []
    chunks = []
    idx = 0
...
#  CSV
# ═════════════════════════════════════════════════════════════
def extract_csv_text(file_path: str) -> list[TextChunk]:
    chunks = []
    idx = 0
    try:
...
#  PPTX
# ═════════════════════════════════════════════════════════════
def extract_pptx_text(file_path: str) -> list[TextChunk]:
    if not PPTX_OK:
        return []
    chunks = []
    idx = 0
...
#  TXT / RTF
# ═════════════════════════════════════════════════════════════
def extract_txt_text(file_path: str) -> list[TextChunk]:
    chunks = []
    try:
        with open(file_path, "r", encoding="utf-8", errors="ignore") as f:
            content = f.read()
...
def extract_rtf_text(file_path: str) -> list[TextChunk]:
    if not RTF_OK:
        return []
    chunks = []
    try:
